...
Dans son répertoire des médias (comptant 26 éléments comme 26 lettres d'un l'alphabêt médiatique), McLuhan place l'écriture (*the written word*) entre la parole (*the spoken word*) et l'ensemble des routes et des cartes (*roads and paper routes*), soit entre ce qui se performe et ce qui s'organise. Au travers des formes technologiques de sa diffusion et de sa production (dont la {{< themes theme="machine">}}machine est un des principes) McLuhan pense l'écriture comme une structure et en fait, c'est là son originalité, un média en tant que tel (bien que le terme média puisse désigner plusieurs choses pour le sociologue canadien). Si son approche est principalement historiographique, elle a le mérite de faire de l'écriture une architecture active de la culture, au même titre que le vêtement, l'argent ou la presse. 

Dans la perspective du média, l'écriture sera abordée comme ce qui agence des interactions culturelles mais aussi ce qui est produit par ces mêmes agencements. 
