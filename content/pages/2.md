...
![Récolte (aile de cigale). Première étape de la création *Nervure*](/images/nervrure.png)
...
<div id="coincidence" title="La Coincidence">
...
<div id="metamorphose" title="La Métamorphose" >
...
<div id="encryption1" title="Première encryption" class="small">
...
<div id="encryption2" title="Deuxième encryption" class="small">
<pre><code class="language-python">
 x=open(&apos;Goldsmith.txt&apos;).read()
&gt;&gt;&gt; y=open(&apos;Bon.txt&apos;).read()
&gt;&gt;&gt; print(&apos;&apos;.join(chr(ord(a) | ord(b)) for a, b in zip(x, y)))
